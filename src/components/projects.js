                    ...
                    <Col xs={{ size: "6", offset: "3" }}>
                        <Card className="projectCard">
                            ...
                            <CardBody>
                                ...
                                <CardText>Battlesphere is my first large project. The app is designed to give players of Magic the Gathering a central location to search for cards, build decks, gather information, and play games.  </CardText>
                                <Row>
                                    <Col xs="6">
